...
if( ( isset($name) && !empty($name) ) && ( isset($email) && !empty($email) ) && ( isset($user_msg) && !empty($user_msg) ) && ( isset($phone) && !empty($phone) ) ) {
	...
	$to = "MIAlearning2@gmail.com"; //Programmers email
	...
	$header  = "MIAlearning2@gmail.com";
	$subject = "Thank You $name";
	$message = "We are here for achieve your expectations. \nThank you for your FEEDBACK Form MIA team.\n CEO EP";
				...
				<div class="container clearfix">
					...
					<div class="sidebar col_last nobottommargin">
						...
						<div class="widget noborder notoppadding">
							...
							<a target="_blank" href="https://www.youtube.com/@MIALearning-un7ul" class="social-icon si-small si-dark si-youtube">
