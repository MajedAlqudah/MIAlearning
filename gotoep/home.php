    ...
    if($power == 'yes'){
       ...
       if ($deluser != 4) {
        ...
        $alertMessage = "<div class='alert alert-danger'> 
            ...
            $alertMessage = "<div class='alert alert-danger'> 
            <p>Please Majed cannot Delete yourself <strong>THANK YOU.</strong> </p><br>       
            <a type='button' class='btn btn-default btn-sm' data-dismiss='alert'>Cancel</a> 
            </div>";
        }        
    }else{
        $alertMessage = "<div class='alert alert-danger'> 
        <p>You are not a Sophisticated Admin. So, You dont have the right to delete any Admin <strong>THANK YOU.</strong> </p><br>       
        <a type='button' class='btn btn-default btn-sm' data-dismiss='alert'>Cancel</a> 
        </div>";
    }
}
...
?>
		...
		<!-- Document Wrapper
	============================================= -->
    <link rel="stylesheet" href="varnav.css">
    <link rel="website icon" href="../images/Desktop (1)/favicon_16.png" type='png'>
	<div id="wrapper" class="clearfix">
        ...
        <section id="page-title" style="margin-padding: 0px;">
            ...
            <div id="page-menu-wrap" style="background-color:#63ccca">
