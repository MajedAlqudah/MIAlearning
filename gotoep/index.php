...
<head>
	...
	<link rel="website icon" href="./images/tab.png" type="png">
				...
				<div class="section nobg full-screen nopadding nomargin">
					<div class="container vertical-middle divcenter clearfix">
						...
						<div class="row center">
							<a href="index.php"><img height="160px" width='400px' src="../images/1.png" alt="MIA" style="cursor: default;"></a>
						</div>

						<div class="panel panel-default divcenter noradius noborder" style="max-width: 400px; background-color: #63ccca;">
						...
						<div class="row center dark" style="text-shadow:2px 2px 10px black;"><small>Copyrights &copy; 2024 All Rights Reserved by MIA.</small></div>
