                ...
                <?php
                 ...
                 ?>
                    ...
                    <div class="form-group">
                        <label for="nameId1">Content Name</label>
                        <input type="text" id="nameId1" placeholder="Content Name" name="name" class="form-control" title="Only lower and upper case and space" pattern="[A-Za-z/\s]+">
