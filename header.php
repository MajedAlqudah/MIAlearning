...
<head>
	...
	<meta name="author" content="MIAProgrammers" />
	<meta name=description content="MIA Programmers">
		...
		<header id="header" class=" full-header" data-sticky-class="not-dark">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.php?pag=home" class="standard-logo" data-dark-logo="images/logo.png"><img src="images/logo.png" alt="MIA Logo"></a>
						<a href="index.php?page=home" class="retina-logo" data-dark-logo="images/logo.png"><img src="images/logo.png" alt="MIA Logo"></a>
					</div><!-- #logo end -->
					...
					<nav id="primary-menu" class="dark">
						...
						<ul>
							...
							<li><a href="index.php?page=gpa"><div>Gpa Calculator</div></a></li>
							...
							<li><a href="index.php?page=team"><div>Team</div></a>
										...
										<ul>
											...
											<li class="mega-menu-title"><a href="index.php?page=team"><div>Supervisor</div></a></li>
											<li class="mega-menu-title"><a href="index.php?page=team"><div>Members</div></a></li>												
